...
async function main() {
  ...
  const dev1 = await prisma.user.upsert({
    ...
    create: {
      ...
      password: 'password123',
      name: 'Bob Dupont',
      bio: 'Dev mobile React Native + Flutter. 4 ans experience. Contact: bob@gmail.com',
      role: 'DEVELOPER',
    },
  })
  ...
  const dev2 = await prisma.user.upsert({
    ...
    create: {
      ...
      password: 'password123',
      name: 'Kevin Moreau',
      bio: 'Dev backend NestJS + PostgreSQL. Architectures scalables. Contact: kevin@gmail.com',
      role: 'DEVELOPER',
    },
  })
  ...
  const dev3 = await prisma.user.upsert({
    ...
    create: {
      ...
      password: 'password123',
      name: 'Julie Bernard',
      bio: 'Fullstack Next.js + Node.js. Projets EdTech et HealthTech. Contact: julie@gmail.com',
      role: 'DEVELOPER',
    },
  })
